...
class TestEvaluateGuess:
    ...
    def test_all_same_color_partial_match(self):
        ...
        result = evaluate_guess(secret, guess)
        assert result == Feedback(black_pegs=2, white_pegs=0)
